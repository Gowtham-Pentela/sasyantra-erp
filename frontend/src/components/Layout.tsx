...
const NAV = [
  ...
  { to: '/clients', label: 'Clients', icon: Building2, live: true },
  { to: '/quotations', label: 'Quotations', icon: FileText, live: true },
  { to: '/work-orders', label: 'Work Orders', icon: ClipboardList, live: true },
  ...
  { to: '/analytics', label: 'Analytics', icon: PieChart, live: true },
  { to: '/activity', label: 'Activity Logs', icon: History, live: true },
  { to: '/documents', label: 'Documents', icon: Folder, live: true },
